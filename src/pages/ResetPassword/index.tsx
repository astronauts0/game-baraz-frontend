  ...
  return (
    <div className="min-h-screen lg:h-screen flex items-center justify-center bg-slate-50 py-6 lg:py-0">
      <ContainerDiv className="w-full">
        {/* The Card */}
        <div className="reset-password-card w-full bg-white rounded-3xl shadow-primary flex flex-col lg:flex-row overflow-hidden border border-slate-100 h-auto lg:h-[85vh] max-h-[700px] max-w-[1050px] mx-auto">
          {/* Left Panel */}
          ...
          <div className="w-full lg:w-[60%] bg-white relative flex flex-col">
            <div className="p-6 lg:p-12 flex flex-col justify-center flex-1 overflow-y-auto no-scrollbar">
              <div
                ...
                className="reset-password-content w-full max-w-md mx-auto"
              >
                {/* Mobile Logo */}
