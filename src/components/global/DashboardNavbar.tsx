...
const DashboardNavbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: "Disputes", path: "/dashboard/disputes" },
    ...
    <nav className="sticky top-0 sm:top-3 left-0 w-full z-50 max-w-[1440px] mx-auto lg:px-8">
      <div className="glass_box rounded-none! sm:rounded-2xl! px-4 sm:px-6 py-2 sm:py-3 flex items-center justify-between shadow-xl shadow-slate-200/50 border border-white/40 transition-all duration-300">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-4 lg:border-l border-slate-200 lg:pl-6">
            <Button
              variant="ghost"
              size="icon"
              className="relative text-slate-400 hover:text-slate-600 transition-colors h-9 w-9"
            >
            ...
            <div className="hidden lg:flex items-center gap-4">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="flex items-center gap-3 px-1 sm:px-2 hover:bg-slate-50 transition-all rounded-xl focus-visible:ring-0 h-9"
                  >
